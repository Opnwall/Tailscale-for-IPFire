...
```
然后登录 Tailscale 管理后台，点击 IPFire设备 列表右侧的Edit route setting，选中启用“ Subnet routes”。
...
```
然后登录 Tailscale 管理后台，点击 IPFire设备 列表右侧的Edit route setting，选中启用 “Use as exit node”。
